...
function Formnew() {
  ...
  return (
    <div>
        ...
        <Modal  open={isModalOpen} width={'60%'}  onCancel={handleCancel} footer={null}  maskClosable={false}>
        ...
        <Button variant="outline-dark" onClick={()=>showModal()} className='mod-btn'  ref={buttonModal}>NEW REGISTRATION<SchoolTwoToneIcon className='school'/></Button>
